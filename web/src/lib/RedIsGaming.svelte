...
<section class="bg-gray w-full relative top-24 flex justify-center text-black dark:bg-dark dark:text-white">
  <article class="my-12 mx-3 lg:mx-0 text-base sm:text-lg" style="width: 1024px;">
