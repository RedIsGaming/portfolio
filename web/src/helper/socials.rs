...
pub fn icon() -> String {
    iconify::svg!("mingcute:arrow-right-fill", width="32", height="32", color="red").to_owned()
}
...
pub fn Socials() -> impl IntoView {
    ...
    let socials_info = SocialsInfo::new(
        ...
        vec![
            "https://github.com/RedIsGaming/".to_owned(),
            "https://www.youtube.com/@RedIsGaming".to_owned()
        ],
    );

    view! {
        <section class="bg-zinc-50 dark:bg-zinc-950 w-full font-mono text-black dark:text-white flex justify-center
            items-center flex-col pt-12 px-3 lg:px-32 text-center">
